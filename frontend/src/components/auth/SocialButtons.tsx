        ...
        <div className="flex flex-col gap-3">
            <Button variant="outline" type="button" onClick={handleGoogle} className="w-full">
                <svg className="mr-2 h-4 w-4" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path fill="#4CAF50" d="M24,44c5.166,0,9.86-1.977,13.409-5.192l-6.19-5.238C29.211,35.091,26.715,36,24,36c-5.202,0-9.619-3.116-11.283-7.471l-6.555,4.887C9.467,39.664,16.142,44,24,44z" />
